...
const vendingMachine = createMachine({
  ...
  states: {
      ...
      on: {
        START: {
          ...
          actions: async () => {
            ...
            console.log('After starting vending cycle');
      ...
      on: {
        PAYMENT: {
          ...
          actions: (context, event) => {
            ...
            const paymentData = event.payload; // Corrected access to event
            ...
            return { paymentData: event.payload }; // Corrected access to event
          }
        },
        TIME_OUT: "idle",
      },
    ...
    payment: {
      ...
      // to confirm the payment and release the product.
      on: {
        TIME_OUT: "idle",
        CANCELED: "idle",
        SUCCESS:  {
          ...
          actions: () => {
            ...
            if (frontEndDevice && frontEndDevice.ws) {
              ...
              log.info("amount", amount); // Ensure 'amount' is defined
