...
const vendingMachine = createMachine(
  ...
  },
  {
    actions: {
      ...
      // TODO: if we use it for reseting vending cycle change the name of it.
      cancelPayment: async () => {
        ...
        // actor.send({ type: "payment.timeout" });
      },
    },
  },
);
...
mdbClient.on("mdb/statusVEND", (statusVendEvent) => {
  ...
  // TODO: this is hacky but for some reason when using CZK the machine gives us 18.99 instead of 1899 CZK
